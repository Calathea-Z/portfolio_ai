    ...
    <div className="relative min-h-full bg-bg text-text">
          ...
          <div className="flex items-center gap-3">
            ...
            {hasResumePdf ? (
              <a
                ...
                download
                className="rounded-lg border border-border-soft bg-surface px-4 py-2 text-sm font-medium text-text transition-colors hover:border-border-strong hover:bg-surface-alt"
              >
                Download (.docx)
              </a>
            ) : null}
      ...
      <main className="mx-auto max-w-3xl space-y-10 px-6 py-12">
        <section>
          ...
          <p className="mt-2 text-lg text-secondary">Full-stack engineer · Denver, CO (remote-first)</p>
        ...
        <section>
          ...
          <ul className="mt-4 space-y-6 text-sm leading-relaxed text-secondary">
            <li>
