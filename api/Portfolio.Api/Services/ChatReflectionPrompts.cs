...
internal static class ChatReflectionPrompts
{
    ...
    internal const string PlannerAppendix =
        "Planning: If the visitor's question is in scope (Zach's resume/portfolio facts), before your first tool call in a turn write one short sentence listing which resume tools you will call and why, then call them, then answer in clear first-person-as-Zach prose grounded only in tool outputs (no third-person \"Zach\" / \"he\" for career facts). "
